...
import com.studyLog4u.entity.auth.AuthReqModel;
...
import com.studyLog4u.oauth.entity.UserPrincipal;
...
import com.studyLog4u.oauth.utils.HeaderUtil;
...
public class AuthController {
    ...
    public ApiResponse refreshToken (HttpServletRequest request, HttpServletResponse response){
        ...
        Claims claims = authToken.getExpiredTokenClaim();
        if(claims == null){
